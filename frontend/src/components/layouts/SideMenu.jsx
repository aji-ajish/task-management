...
import MainDiv from "../dashboard/MainDiv";
  ...
  return (
    <div>
            ...
            <li>
              <p className="flex cursor-pointer items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg
                  ...
                  strokeWidth={2}
                  stroke="currentColor"
                  className="size-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
      ...
      <div className="p-4 sm:ml-64 h-screen">
            <div className="p-4 border-2 h-full  border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                <Routes>
