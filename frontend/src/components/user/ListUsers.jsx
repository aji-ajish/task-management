                            ...
                            <nav className="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4" aria-label="Table navigation">
                                <span className="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
                                    Limit <span className="font-semibold text-gray-900 ml-1">
                                        <select className='outline-none border-none p-1 rounded-lg dark:bg-gray-500 bg-white' onChange={(e)=> handleLimitChange(e.target.value)}>
                                            ...
                                            <option className='text-black dark:text-white' value={50}>50</option>
                                        </select>
                                    </span>
                                </span>
                                <span className="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
